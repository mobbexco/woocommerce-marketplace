...
class MobbexMarketplace
{
    ...
    public static function check_dependencies()
    {
        ...
        if(!is_plugin_active('mobbex-for-woocommerce/mobbex-for-woocommerce.php') && version_compare(MOBBEX_VERSION, '3.1.1', '<')) {
        ...
        if (is_plugin_active('mobbex-for-woocommerce/mobbex-for-woocommerce.php') && version_compare(MOBBEX_VERSION, '3.1.3', '<')) {
